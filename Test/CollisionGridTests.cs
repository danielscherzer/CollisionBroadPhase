...
public class CollisionGridTests
{
	...
	private static IEnumerable<object[]> GetGameObjects()
	{
		...
		yield return new object[] { new GameObject[] { a, new(1, 1, 0.1f) }, Array.Empty<(int, int)>() };
		yield return new object[] { new GameObject[] { a, new(0.01f, 0, 0.1f) }, new (int, int)[] { (0, 1) } };
		yield return new object[] { new GameObject[] { a, new(0.19f, 0, 0.1f) }, new (int, int)[] { (0, 1) } };
		yield return new object[] { new GameObject[] { a, new(0.2f, 0, 0.1f) }, Array.Empty<(int, int)>() };
	}
